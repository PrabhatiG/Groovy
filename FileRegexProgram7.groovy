...
class FileRegexProgram7 {
	static void main(args) {
		File file=new File("C:\\Users\\PrabhatiGhosh\\Desktop\\SDET-workspace\\first\\src\\firstprogram\\Untitled 1");
		file.createNewFile();
		
		file.write("A Quick Brown Fox Jumped Over The Lazy Cow\n")
		file.append("John Jimbo jingeled happily ever after\n")
		file.append("Th1\$ 1\$ v3ry c0nnfu51ng")
